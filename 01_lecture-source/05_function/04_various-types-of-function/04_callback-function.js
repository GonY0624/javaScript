...
/*
    함수의 매개변수를 통해서 다른 함수의 내부로 전달되는 함수를 "콜백 함수"라고 한다.
    매개 변수를 통해 함수의 외부에서 콜백함수를 전달받은 함수는 고차함수라고 한다. 
...
function apply(func, value){
    ...
    // 콜백 함수는 고차 함수에 의해 호출(헬퍼) 되며, 이 때 고차함수는 
    // 필요에 따라 콜백함수에 의해 인수를 전달할 수 있다.
    return func(value);
}
