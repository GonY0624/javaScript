...
// hello('정고은');
// console.log(hello('정고은'));
var result = hello('정고은');
console.log(result);
...
// 모든 인수는 암묵적으로 argiments 객체의 프로퍼티로 보관된다. 
result = hello('정고은', '돼지똥');
console.log(result);

function hi(name = '돼지똥'){
    
    // 인수를 전달하지 않았을 경우, undefined 를 전달했을 경우 ES6 에서 도입된
    // 매개변수 기본값을 사용할 수 있다. 
