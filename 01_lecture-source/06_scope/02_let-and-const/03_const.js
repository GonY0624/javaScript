/* const
    ...
    let 키웓르와 마찬가지로 블록 레벨 스콜프를 가진다. 
*/

// const 키워드를 반드시 선언과 동시에 초기화를 해야한다. 
...
// const 키워드로 선언된 변수에 객체를 할당한 경우 값(프로퍼티 값) 은 변경할 수 있다. 
student.name = '박용남';
console.log(student);

// student 에 객체의 주소값은 변경할 수 없지만, 프로퍼티들의 값은 변경할 수 있다. 
// student = {};

/* ES6
    var 라는 키워드는 사용하지 않는다. 
    재할당이 필요한 경우 한정적으로 let 키워드를 사용하며, 변수의 스코프는 최대한 좁게 만든다. 
    변경이 발생하지 않고, 읽기 전용으로 사용하는 원시 값과 객체에는 const 키워드를 사용하다. 
