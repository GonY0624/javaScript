...
// 숫자가 아닌 값들은 암묵적으로 타입으로 변환한다.

console.log(10-'5');
console.log(10 % 'javaScript'); // 피연산자 숫자 변환이 불가능하다. NaN(숫자가 아님.)
console.log(10 > '6');
...
// 빈문자열, 빈 배열, null, false 는 0으로 반환, true 는 1 로 반환
// 객체와 undefined 는 변환이 되지 않나 NaN 반환
